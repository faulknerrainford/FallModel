...
class Reset(FallReset.Reset):
    ...
    def set_nodes(tx):
        ...
        tx.run("CREATE (a:Node {name:'Intervention', energy:-0.8, modm:0.3, modc:0.3, cap:4, load:0})")
        tx.run("CREATE (a:Node {name:'InterventionOpen', energy:-0.8, modm:0.3, modc:0.3, cap:0, load:0})")
