---------------------------------
Carer Physical Agent Algorithm
---------------------------------
...
4. Listen
    + If they have a new social contact who has a contact to a carer there is a .5 chance that :math:`Agent_a` also forms a social contact with that carer
5. React
